                ...
                <div class="xl:col-span-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="transferForm" action="{{ route('transfers.update', $transfer->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-12">
                                    ...
                                    <div class="xl:col-span-6">
                                        ...
                                        <input type="text" name="guichetier_provenance" id="guichetier_provenance"
                                            ...
                                            value="{{ $transfer->guichetier_provenance }}">
                                    ...
                                    <div class="xl:col-span-6">
                                        ...
                                        <input type="text" name="guichetier_destination" id="guichetier_destination"
                                            ...
                                            value="{{ $transfer->guichetier_destination }}">
                                ...
                                <div class="flex justify-end gap-2 mt-4">
                                    ...
                                    <button type="submit" id="submit_btn"
                                        class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Update Transfer</button>
                                </div>
                            </form>
                        </div>
                    </div>
